...
export default function DeanComplaintsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 text-green-700">รายการเรื่องร้องเรียน - คณบดี</h1>
        {complaints.length === 0 ? (
            ...
            <table className="min-w-full bg-white rounded-lg shadow-md">
              ...
              <tbody>
                {complaints.map((complaint) => (
                  <tr key={complaint.complaintId} className="border-b hover:bg-green-50">
                    ...
                    <td className="py-3 px-4">
                      <Link href={`/dean/complaints/${complaint.complaintId}`} className="text-green-600 hover:underline font-bold">ดูรายละเอียด</Link>
                    </td>
                  </tr>
                ))}
              </tbody>
